...
'''This code generates a CHM from the TBS point cloud published by Purdue GDSL and the collaborators
The code initially published by Minyoung Jung (jung411@purdue.edu) in Sep. 2025
Plese check the comments when you want to modify the codes.'''
